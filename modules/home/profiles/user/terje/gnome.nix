    ...
    (lib.mkIf cfg.paperwm.enable {
      ...
      dconf.settings = {
        ...
        "org/gnome/shell/extensions/paperwm/keybindings" = {
          ...
          switch-monitor-left = ["<Super>Left" "<Alt><Super>bracketleft"];
          move-monitor-left = ["<Shift><Super>Left" "<Shift><Alt><Super>bracketleft"];
          switch-monitor-right = ["<Super>Right" "<Alt><Super>bracketright"];
          move-monitor-right = ["<Shift><Super>Right" "<Shift><Alt><Super>bracketright"];
